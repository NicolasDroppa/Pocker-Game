...
public class Hand {
	...
	public String has() {
		...
		if (isThreeOfAKind()) { results = "Three of a kind"; }
		else if (isFourOfAKind()) { results = "Four of a kind";  }
		else if (isOnePair()) { results = "One pair";  }
		else if (isTwoPair())  { results = "Two Pair";  }
		else if (isStraight())  { results = "Straight";  }
		else if (isFlush()) { results = "Flush";  }
		else if (isStraightFlush()) { results = "Straight Flush";  }
		else if (isFullHouse()) { results = "Full House";  }
